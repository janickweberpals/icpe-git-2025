...
## Popular legacy frameworks - RMarkdown {visibility="hidden"}
...
## Popular legacy frameworks - Jupyter {visibility="hidden"}
...
## Document complexity of technical report {visibility="hidden"}
...
## Introduction to Quarto {visibility="hidden"}
...
The sample size comprised `r text_string` patients.
````
