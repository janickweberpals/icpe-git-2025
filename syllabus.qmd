...
### GitHub Account Setup {#sec-github-account }
...
### GitHub Copilot {#sec-github-copilot }
...
### Fork the GitHub Codespaces Template 
...
![Fork the codespace template.](images/fork-codespaces-1.png){#fig-fork-1}

4.  Optional: Rename your forked version (e.g., my-codespace-ICPE25, see @fig-fork-2)

![Rename the personal fork (copy) of the codespace.](images/fork-codespaces-2.png){#fig-fork-2}

5.  Go to `Code > Codespaces > Create codespace on main` (@fig-start-codespace)

![Creating and starting a codespace on the main branch.](images/start-codespace.png){#fig-start-codespace}
